defmodule Decoction.ImageControllerTest do
  use Decoction.ConnCase

  alias Decoction.Image
  @valid_attrs %{nsfw: true, source_link: "some content", tags: "some content", text: "some content", url: "some content"}
  @invalid_attrs %{}
